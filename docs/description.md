...
Bakti is a Stellar mainnet product for Filipino workers in Malaysia planning salary-day support for family in the Philippines. A sender connects Freighter, saves a family member's Stellar address, amount, asset, and reminder date, then signs either a direct XLM/USDC payment or an XLM Soroban escrow release. Bakti verifies the on-chain transaction and records its hash.

            ...
            <ol className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  d: 'Funds settle to a cash-pickup reference issued by a partner anchor (SEP-31).',
                },
                {
                  icon: MapPin,
        ...
        <section className="grid gap-4 pb-6 sm:grid-cols-3">
          {[
            ...
            },
            {
              ...
              body: 'A SEP-31 partner anchor turns the on-chain payment into a local cash-pickup code — dignity for parents who never touch crypto.',
            },
          ].map((f) => (
            ...
            {[
              {
                n: '1',
                t: 'Connect',
                d: 'Link your Stellar wallet — pinned to the network you pick in the header, whatever your wallet says.',
              },
              {
                n: '2',
                t: 'Add a parent',
